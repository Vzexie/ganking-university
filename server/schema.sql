...
-- Safe to re-run: adds user_id to board_slots created before this column existed.
ALTER TABLE board_slots ADD COLUMN IF NOT EXISTS user_id INTEGER REFERENCES users(id);
